...
load_dotenv()
def _init_logger(env):
    logging.config.fileConfig(os.path.normpath('logger.ini'))
    logger = None
    if env=='DEVELOPMENT':
    ...
    # Create the logger
    # dev or default root: The name of a logger defined in the config file
...
Logger = _init_logger(os.environ.get('ENV'))